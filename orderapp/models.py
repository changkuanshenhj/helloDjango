...
class OrderModel(BaseModel):
    num = models.CharField(max_length=20,
                           primary_key=True,
                           verbose_name='订单号')  # 当定义主键后，系统不会再主动创建id主键了
    title = models.CharField(max_length=100,
                             verbose_name='订单名称')
    price = models.DecimalField(max_digits=10,
                                decimal_places=2,
                                verbose_name='订单金额')  # 8个整数位，2个小数位
    ...
    receiver_phone = models.CharField(max_length=11, verbose_name='收获人的手机')
    receiver_address = models.TextField(verbose_name='收获地址')
